...
/**
 * The "old" tabular scenario detail breakdown — a dense multi-column matrix
 * table, ported from the SCIDetails4 monolith's original design. Kept as
 * SCIDetail's own component (separate from the card-based ScenarioDetailCard
 * that NetworkDownStockingAgent still uses) so the two designs stay independent.
 */
