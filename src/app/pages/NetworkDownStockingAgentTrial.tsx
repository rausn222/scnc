...
import { SelectCbuStep } from "../components/networkDownStockingAgentTrial/step1/SelectCbuStep";
import { SelectCbuPlaceholder } from "../components/networkDownStockingAgentTrial/step1/SelectCbuPlaceholder";
import { SimulationAssumptionsStep } from "../components/networkDownStockingAgentTrial/step2/SimulationAssumptionsStep";
import { ScenarioComparisonStep } from "../components/networkDownStockingAgentTrial/step3/ScenarioComparisonStep";
...
export default function NetworkDownStockingAgentTrial({ srNo, preserveState }: Readonly<Props>) {
    ...
    >
      <PageHeader
        ...
        breadcrumbs={[
          ...
          {
            label: "Network Down Stocking Simulator",
