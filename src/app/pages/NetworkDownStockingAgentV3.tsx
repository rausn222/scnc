...
import { SelectCbuStep } from "../components/networkDownStockingAgentV3/step1/SelectCbuStep";
import { SelectCbuPlaceholder } from "../components/networkDownStockingAgentV3/step1/SelectCbuPlaceholder";
import { SimulationAssumptionsStep } from "../components/networkDownStockingAgentV3/step2/SimulationAssumptionsStep";
import { ScenarioComparisonStep } from "../components/networkDownStockingAgentV3/step3/ScenarioComparisonStep";
...
export default function NetworkDownStockingAgentV3({ srNo }: Readonly<Props>) {
  ...
  const handleOldCbuChange = (nextIds: number[]) => {
    ...
    if (nextPrimary == null) {
      ...
      navigate({ page: "network-down-stocking-agent-v3" });
    } else if (nextPrimary !== srNo) {
      navigate({ page: "network-down-stocking-agent-v3", srNo: nextPrimary });
    }
  };
