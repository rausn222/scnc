...
import { SelectCbuStep } from "../components/networkDownStockingAgent/step1/SelectCbuStep";
import { SelectCbuPlaceholder } from "../components/networkDownStockingAgent/step1/SelectCbuPlaceholder";
import { SimulationAssumptionsStep } from "../components/networkDownStockingAgent/step2/SimulationAssumptionsStep";
import { ScenarioComparisonStep } from "../components/networkDownStockingAgent/step3/ScenarioComparisonStep";
...
export default function NetworkDownStockingAgent({ srNo }: Readonly<Props>) {
  ...
  const handleOldCbuChange = (nextIds: number[]) => {
    ...
    if (nextPrimary == null) {
      ...
      navigate({ page: "network-down-stocking-agent" });
    } else if (nextPrimary !== srNo) {
      navigate({ page: "network-down-stocking-agent", srNo: nextPrimary });
    }
  };
